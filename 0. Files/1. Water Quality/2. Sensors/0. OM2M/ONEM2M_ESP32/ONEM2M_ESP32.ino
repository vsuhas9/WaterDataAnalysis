...
// CSE params
const char* host = "dev.onem2m.iiit.ac.in";
const int httpPort = 443;

// AE params
const int aePort   = 443;
const char* origin   = "devtest:devtest";
///////////////////////////////////////////
...
void setup() {
  ...
  //if(resulat=="HTTP/1.1 201 Created"){
    ...
    // Create ContentInstance resource
    send("/~/mn-cse1/air-quality-monitoring/Air_Quality_Monitoring/AQ_MG00_01/Data",4,"{\"m2m:cin\":{\"con\":\"OFF\"}}");
